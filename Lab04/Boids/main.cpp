...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(desktop.width, desktop.height, desktop.bitsPerPixel), "Boids", sf::Style::Default); 
	
	//Create flock, vector of shapes, and initialize boids
	Flock flock;
	vector<sf::CircleShape> shapes;

	for (int i = 0; i < noOfBoids; i++) //Number of boids is hardcoded for testing pusposes.
	{
